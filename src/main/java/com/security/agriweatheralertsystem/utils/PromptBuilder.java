...
public class PromptBuilder {
    public static String IntentAndLocationPrompt(String userInput) {
        return """
                ...
                2. Extract the **location** if it is mentioned (leave empty if not mentioned).

                3. Detect the **language** of the input:
                   - english (fully in English)
                   - hindi (fully in Hindi or mix of Hindi written in Latin script or Hindi + English )
